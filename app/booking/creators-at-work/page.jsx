...
const SHOW = {
  name: "Creators at Work",
  tagline:
    "A show for creators, builders, and entrepreneurs who want to grow their craft, their audience, and their business with real systems—not hype.",
};

const CALENDLY_BASE_URL =
  "https://calendly.com/donalddunn/creators-at-work";
...
export default function BookingCreatorsAtWorkPage() {
  return (
