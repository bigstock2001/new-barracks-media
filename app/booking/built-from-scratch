...
const SHOW = {
  ...
  tagline:
    "Real conversations about building businesses, systems, and momentum—from zero to something that lasts.",
};

const CALENDLY_BASE_URL =
  "https://calendly.com/donalddunn/built-from-scratch";
...
export default function BookingBuiltFromScratchPage() {
  return (
