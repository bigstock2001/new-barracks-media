...
const SHOW = {
  ...
  tagline:
    "Conversations focused on healing, resilience, faith, mindset, and the deeper work that transforms lives.",
};

const CALENDLY_BASE_URL =
  "https://calendly.com/donalddunn/the-healing-side";
      ...
      <div className="mx-auto max-w-5xl px-5 py-12 space-y-10">
        ...
        <section className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-8">
          ...
          <p className="opacity-85 mt-2">
            Join the Barracks Media newsletter for booking openings and
...
export default function BookingTheHealingSidePage() {
  return (
